function [t,y] = MSN(I_Ext_MSN_Soma,I_Ext_MSN_Dendrite)
%%%%%%%%% S = 2.7*1e-5 (cm^2);
tic
%%%%%%%depth = 15;
t = 0:0.02:3000;
...
y = zeros(56,1);
[t,y] = ode45(@S_MSN,t,y0);
plot(t,y(:,1))
toc


    function dy = S_MSN(t,y)
        dy = zeros(56,1);%---------------Column      1 Soma ; 2 Proximal
                     %---------------           Soma: 3 - 30
        ...
        dy(1) = -I_ion_MSN_Soma - 10*g_Rall_MSN(1)*(y(1)-y(2)) + I_Ext_MSN_Soma;
