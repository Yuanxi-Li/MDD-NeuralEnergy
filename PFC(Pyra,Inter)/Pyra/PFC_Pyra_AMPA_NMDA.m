function [t,y] = PFC_Pyra_AMPA_NMDA(I_Ext_PFC_Pyra_Soma,I_Ext_PFC_Pyra_Proximal,I_Ext_PFC_Pyra_Distal)
...
AMPA_PFCPyra2MSN = SynapseChannel('AMPA','PFCPyra','MSN',0.05,1,0.2,0);
NMDA_PFCPyra2MSN = SynapseChannel('NMDA','PFCPyra','MSN',0.05,0.072,0.0067,0);


y0 = Initial_PFC_Pyra(V_PFC_Pyra_Soma,V_PFC_Pyra_Proximal,V_PFC_Pyra_Distal);
y0 = [y0;0;0];
[t,y] = ode23(@S_PFC_Pyra_AMPA_NMDA,t,y0);

toc

    function dy = S_PFC_Pyra_AMPA_NMDA(t,y)
        dy = zeros(14,1);  %1 Soma 2 Proximal 3 Distal
    ...
    tauh_PFC_Pyra_Proximal_Na, infh_PFC_Pyra_Proximal_Na] = inftau_PFC_Pyra_Proximal_mh_Na(y(2));
        ...
        dy(13) = AMPA_PFCPyra2MSN.alpha*T_Presynapse_Pyra2MSN*...
            (1-y(13))-AMPA_PFCPyra2MSN.beta*y(13);%AMPA Gates
        I_AMPA_Pyra2MSN = AMPA_PFCPyra2MSN.gmax*y(13)*(y(1)-AMPA_PFCPyra2MSN.rev);%Postsynapse:Soma of Pyramidal
        dy(14) = NMDA_PFCPyra2MSN.alpha*T_Presynapse_Pyra2MSN*(1-y(14))-NMDA_PFCPyra2MSN.beta*y(14);%NMDA Gates
        I_NMDA_Pyra2MSN = NMDA_PFCPyra2MSN.gmax*y(14)*NMDA_Mg_Block_MSN*(y(1)-NMDA_PFCPyra2MSN.rev);
...
%         I_Soma = I_Na_Soma+I_K_Soma;
        gc1 = 0.75;
        p1 = 0.5;
        dy(1) = -I_PFC_Pyra_Soma_Ion-gc1*(y(1)-y(2))/p1+I_Ext_PFC_Pyra_Soma +I_MSN_Excitatory;
